document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const errorFallback = contactForm.dataset.errorMessage || 'Something went wrong. Please try again.';
        ...
        fetch(formAction, {
          ...
          .then(function (response) {
            if (response.ok) {
              ...
              showFormMessage(contactForm, errorFallback, 'error');
            }
          })
          .catch(function () {
            showFormMessage(contactForm, errorFallback, 'error');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '870bed44-20d0-4415-a0a9-36ff1924029e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '870bed44-20d0-4415-a0a9-36ff1924029e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '870bed44-20d0-4415-a0a9-36ff1924029e';
